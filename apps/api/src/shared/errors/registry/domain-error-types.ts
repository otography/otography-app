import type { DomainProblemSlug, ErrorStatusCode } from "@repo/errors";
...
/**
 * 全ドメイン固有エラー型のレジストリ。
 * 汎用型（bad-request, internal-error, not-found 等）は http-error-types.ts の STATUS_ERROR_TYPES で扱う。
 */
