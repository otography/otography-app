...
ALTER TABLE "artists" ADD COLUMN "apple_music_id" varchar(100) DEFAULT '' NOT NULL;--> statement-breakpoint
ALTER TABLE "songs" ADD COLUMN "apple_music_id" varchar(100) DEFAULT '' NOT NULL;--> statement-breakpoint
