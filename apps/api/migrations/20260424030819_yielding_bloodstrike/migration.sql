...
ALTER TABLE "artists" ALTER COLUMN "type" SET DATA TYPE "artist_type" USING "type"::"artist_type";--> statement-breakpoint
ALTER TABLE "artists" ALTER COLUMN "birthplace" SET DATA TYPE "prefecture" USING "birthplace"::"prefecture";--> statement-breakpoint
ALTER TABLE "users" ALTER COLUMN "birthplace" SET DATA TYPE "prefecture" USING "birthplace"::"prefecture";--> statement-breakpoint
CREATE INDEX "idx_artists_not_deleted" ON "artists" USING btree ("id") WHERE "deleted_at" IS NULL;
