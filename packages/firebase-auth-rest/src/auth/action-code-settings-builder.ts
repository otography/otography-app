...
export class ActionCodeSettingsBuilder {
  ...
  constructor(actionCodeSettings: ActionCodeSettings) {
    ...
    if (typeof actionCodeSettings.url === "undefined") {
      throw new FirebaseAuthError(AuthClientErrorCode.MISSING_CONTINUE_URI);
    } else if (!validator.isURL(actionCodeSettings.url)) {
      throw new FirebaseAuthError(AuthClientErrorCode.INVALID_CONTINUE_URI);
    }
    this.continueUrl = actionCodeSettings.url;

    if (
      typeof actionCodeSettings.handleCodeInApp !== "undefined" &&
    ...
    if (
      ...
      throw new FirebaseAuthError(AuthClientErrorCode.INVALID_DYNAMIC_LINK_DOMAIN);
    }
    ...
    if (
      ...
      throw new FirebaseAuthError(AuthClientErrorCode.INVALID_HOSTING_LINK_DOMAIN);
    }
    ...
    if (typeof actionCodeSettings.iOS !== "undefined") {
      if (!validator.isNonNullObject(actionCodeSettings.iOS)) {
        ...
        throw new FirebaseAuthError(AuthClientErrorCode.MISSING_IOS_BUNDLE_ID);
    ...
    if (typeof actionCodeSettings.android !== "undefined") {
      if (!validator.isNonNullObject(actionCodeSettings.android)) {
        ...
        throw new FirebaseAuthError(AuthClientErrorCode.MISSING_ANDROID_PACKAGE_NAME);
        ...
        typeof actionCodeSettings.android.minimumVersion !== "undefined" &&
        ...
        typeof actionCodeSettings.android.installApp !== "undefined" &&
