...
export class ProjectConfig {
	...
	public static buildServerRequest(
		configOptions: UpdateProjectConfigRequest,
	): ProjectConfigClientRequest {
		...
		if (typeof configOptions.recaptchaConfig !== "undefined") {
			request.recaptchaConfig = RecaptchaAuthConfig.buildServerRequest(
				configOptions.recaptchaConfig,
			);
		}
		if (typeof configOptions.passwordPolicyConfig !== "undefined") {
			request.passwordPolicyConfig = PasswordPolicyAuthConfig.buildServerRequest(
				configOptions.passwordPolicyConfig,
			);
		}
